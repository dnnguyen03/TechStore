                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-4">
                            ...
                            <div style="width: 160px; height: 160px; overflow: hidden; border: 2px dashed #ccc;">
                                <img id="Photo" src="<?= isset($product['image']) && $product['image'] != null ? "/src/assets/images/" . $product['image'] : '/src/assets/images/no_imgProduct.png' ?>"
                            ...
                            <tr>
                                <td>
                                    <div style="width: 60px; height: 60px; overflow: hidden;">
                                        <img style="width: 100%; height: 100%; object-fit: cover; object-position: center;"  src="<?= isset($photo['image']) && $photo['image'] != null ? "/src/assets/images/" . $photo['image'] : '/src/assets/images/no_imgProduct.png' ?>" alt="photo">
                                    </div>
                                </td>
